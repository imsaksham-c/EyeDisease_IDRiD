...
def create_sample_data_structure():
    ...
    data_dirs = [
        ...
        'data/segmentation_masks/train', 'data/segmentation_masks/val', 'data/segmentation_masks/test',
...
def main():
    parser = argparse.ArgumentParser(description='Multi-Task Vision System for Eye Disease Diagnosis')
    parser.add_argument('--mode', choices=['train', 'eval', 'inference', 'setup'], 
    ...
    parser.add_argument('--input_path', type=str, default=None, help='Path to input image for inference')
    ...
    if args.mode == 'train':
        ...
        try:
            ...
            print("Make sure your data is properly organized. Run with --mode setup to create sample structure.")
