...
class Evaluator:
        ...
        if all_cls_preds:
            ...
            if save_visualizations:
                ...
                self.visualizer.plot_confusion_matrix(
                    cls_targets.numpy(), pred_labels, class_names,
        ...
        if all_seg_preds:
            ...
            if save_visualizations and all_images:
                ...
                self.visualizer.visualize_predictions(
                    sample_images, sample_seg_preds, sample_seg_targets,
    ...
    def compare_with_baseline(self, baseline_results=None):
        ...
        comparison_file = os.path.join(self.config.results_dir, 'baseline_comparison.json')
